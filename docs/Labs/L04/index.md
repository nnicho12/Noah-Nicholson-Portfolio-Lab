...
This outcome is what I expected, the FDM chart states that the max angle was 45 degrees, However the Prusa website stated that it could go up to 75 degrees, so that is around where I expected it to fail. I learned how to better identify the infill percentage I need. I learned that the infill looks differently from the top of the print to the bottom and that I need to select an infill that is effective throughout. I wanted to make an infill and scaling of the model that I knew would stay stable so I made the model wider to have an effective infill at 40%. The failure of the part may potentially be from the force on the part generated by the weight of the printing material rather than the angle at which it failed. The print took 22 minutes to complete.

## Resources

[Prusa Knowledge Base](https://help.prusa3d.com/article/modeling-with-3d-printing-in-mind_164135)

<img width="900" height="675" alt="Design Rules" src="https://github.com/user-attachments/assets/8e109fdc-7cfa-4be8-8ee9-5533907867ad" />
