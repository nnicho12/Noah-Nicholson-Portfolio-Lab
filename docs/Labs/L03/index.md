...
<div style="display:flex; gap:1rem; align-items:flex-start; flex-wrap:wrap;">
  <img src="./DSMcadtop.png" alt="DSMcad top view" style="max-width:48%; height:auto; display:block;">
  <img src="./DSMcadnormal.png" alt="DSMcad normal view" style="max-width:48%; height:auto; display:block;">
</div>
